...
//        Particle moon = new Particle(y, m, ignoreFlags, 2);
//        moon.setMass(734.9);
//        moon.setR(9.439740475765585E-01,  3.268898475011099E-01, -9.702225075623478E-05);
//        moon.setV( -5.726345986229259E-03,  1.567698569439845E-02,  4.764364979627959E-05);
        nodes = new Circle[5];
...
//        }
    ...
    public void initFrameListener(
            ...
            double[] y,
            final double[] m,
            final boolean[] ignoreFlags, double dt, double frameDT) {

        final double timeScale = 3600*24*7*20;
        ...
        AnimationTimer frameListener = new AnimationTimer() {
            ...
            public void handle(long now) {
                ...
                if (frameDuration > 2 * frameDT) {
                    frameDuration = 2 * frameDT;
                }
...
//                System.out.println("non-scaled: " + time + ", " + remainingSimulationTime + ", " + dt);

                // simulate remaining interval
                while (remainingSimulationTime >= frameDT) {
                    ...
                    // integrate
                    try {
//                        System.out.println("scaledT: " + scaledT);
                    ...
                    remainingSimulationTime -= frameDT;
                ...
                // interpolate state
                double alpha = remainingSimulationTime / frameDT;
